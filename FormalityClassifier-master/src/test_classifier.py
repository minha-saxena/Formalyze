...
if len(sys.argv) <= 1:
    pickle_path = r'C:\Users\minha\Desktop\project work\FormalityClassifier-master\saved_data\50000sentences'
elif len(sys.argv) == 2:
...
print(model.summary())
# cat = categorical_accuracy(result,X_test)
# overall = tf.reduce_mean(cat)
# print(overall)
#print(result)
